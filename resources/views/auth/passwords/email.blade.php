      ...
      <div class="col-sm-6 text-black">
        ...
        <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
             ...
             <form style="width: 23rem;" method="POST" action="{{ route('password.email') }}">
                        ...
                        <h3 class="fw-normal pt-5 mb-1 pb-4" style="letter-spacing: 1px;">Reset Password Akun </h3>
                        ...
                        <div class="pt-3 mb-4">
                        <button class="btn btn-info btn-lg btn-block" type="submit">Send Password Reset Link</button>
                        </div>
