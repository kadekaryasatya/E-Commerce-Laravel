      ...
      <div class="col-sm-6 text-black">
        ...
        <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
             ...
             <form style="width: 23rem;" method="POST" action="{{ route('register') }}">
                        ...
                        <h3 class="fw-normal pt-5 mb-1 pb-4" style="letter-spacing: 1px;">Register User </h3>


                         <div class="form-outline pt-1s mb-4">
                             <input id="name" placeholder="Nama" type="text" class="form-control form-control-lg @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                            @error('name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-outline mb-4">
                            <input id="password-confirm" type="password" placeholder="Re-Type Password" class="form-control  form-control-lg" name="password_confirmation" required autocomplete="new-password">
                            @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <p class="small mb-3 pb-lg-2"><a class="text-muted" href="{{ route('password.request') }}">Forgot password?</a></p>
                        ...
                        @if (Route::has('login'))
                    <p>Have an account? <a href="{{ route('login') }}" class="link-info">Login here</a></p>
                        @endif
            </form>
        </div>
